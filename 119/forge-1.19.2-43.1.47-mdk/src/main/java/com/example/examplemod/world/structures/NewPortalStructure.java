...
public class NewPortalStructure extends Structure {



    public static final Codec<NewPortalStructure> CODEC = RecordCodecBuilder.<NewPortalStructure>mapCodec(instance ->
            ...
            ).apply(instance, NewPortalStructure::new)).codec();
    ...
    public NewPortalStructure(Structure.StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context){
        ...
        if (!NewPortalStructure.extraSpawningChecks(context)){
    ...
    public StructureType<?> type(){
        return Structure_Biomes.PORTAL.get();
    }
}
